...
| Archivo | Descripción |
|---------|-------------|
| `environment.example.ts` | Plantilla con valores de ejemplo |
| `environment.ts` | Configuración de desarrollo (no commitear) |
| `environment.prod.ts` | Configuración de producción (no commitear) |
...
4. Configura Storage
5. Copia las credenciales a los archivos de environment

Consulta [`docs/SETUP_CREDENTIALS.md`](docs/SETUP_CREDENTIALS.md) para instrucciones detalladas.
