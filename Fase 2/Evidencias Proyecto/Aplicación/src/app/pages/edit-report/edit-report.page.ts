...
export class EditReportPage implements OnInit {
  ...
  constructor(
    ...
    console.log('EditReportPage constructor called.'); // Debug log
  }

  ngOnInit() {
    console.log('EditReportPage ngOnInit called.'); // Debug log
    ...
    console.log('Report ID from route param:', paramId, 'query param:', queryId, '-> using:', this.reportId); // Debug log
